...
class CronConfig extends \Magento\Framework\App\Config\Value
{
     ...
     * Cron string path
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/product_review_reminder_setup_job/schedule/cron_expr';
 
    /**
     * Cron model path
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/product_review_reminder_setup_job/run/model';
